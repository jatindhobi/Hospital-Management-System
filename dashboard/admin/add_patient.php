...
if (isset($_POST['registerbtn'])) {
  ...
  if ($stmt->execute()) {
    ...
    <span aria-hidden="true">×</span>
      ...
      $sql = "INSERT INTO `book_appointment_tb` (`name`, `phone`,`email`,`symptomes`,`date`,`time`) VALUES ('$name', '$phone', '$email', '$symptomes','$date', '$time')";
...
<head>
  ...
  <title>Add Appointment | Doctor</title>
</head>

<body class="book_appointment">
