...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a href="user_index.php" style="text-decoration: none; color:black;" class="navbar-txt">
  ...
  <li class="nav-item">
    ...
    <a class="nav-link" href="appointment_detail.php">
      ...
      <span>Appointment Detail</span></a>
    <hr class="sidebar-divider">

    <a class="nav-link" href="user_testimonial.php">
