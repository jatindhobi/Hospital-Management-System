...
if (!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] !== true) {
  ...
  header("location: /Hospital Management System/hms/doctor-login.php");
...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a href="doctor_index.php" style="text-decoration: none; color:black;" class="navbar-txt">
  ...
  <!-- Nav Item - Dashboard -->
  <li class="nav-item">
    <a class="nav-link" href="doctor_index.php">
    ...
    <a class="nav-link" href="doctor_calender.php">
    ...
    <a class="nav-link" href="doctor_register.php">
